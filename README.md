...
├── domain/model/                 # Bounding box và dữ liệu khuôn mặt
└── ui/
    ├── FaceDetectionScreen.kt    # Preview, overlay và nhãn trạng thái
    ├── view_model/               # Trạng thái màn hình
    └── widgets/
        ├── CameraPreview.kt      # Camera trước + ML Kit Analyzer
        └── FaceDetectionOverlay.kt # Chỉ vẽ bounding box
```
